...
= IMPORTANT NOTE =
**You do not need to install this plugin if you're running WordPress 5.3 or higher, because this plugin's functionality is merged into WordPress core since WordPress 5.3**
