	...
	<div class="fusion-page-title-row">
		<div class="fusion-page-title-wrapper">
			<div class="fusion-page-title-captions">
				...
				<?php global $post; //using to check the post name?>
				<?php if ( 'center' === $alignment && get_post_type()!= 'sale-bikes' && $post->post_name != 'sale-bikes') : // Render secondary content on center layout, but not on sale bike posts. ?>
